...
describe('backend api contracts', () => {
  test('api contract modules export dto definitions', () => {
    ...
    expect(api.SearchSuggestionDto).toBeDefined();
    expect(api.SearchRequestDto).toBeDefined();
    expect(api.AutocompletePlacesRequestDto).toBeDefined();
    expect(api.PlaceDetailRequestDto).toBeDefined();
    expect(api.SearchReverseGeocodeRequestDto).toBeDefined();
    expect(api.RouteEstimateRequestDto).toBeDefined();
    expect(api.RoutePreviewRequestDto).toBeDefined();
    expect(api.DistanceEstimateResponseDto).toBeDefined();
    expect(api.DurationEstimateResponseDto).toBeDefined();
    expect(api.FareEstimateResponseDto).toBeDefined();
  ...
  test('mapper modules export dto/domain/error contracts', () => {
    ...
    expect(typeof mappers.dtoToDomainSearchResult).toBe('function');
    expect(typeof mappers.domainToSearchRequestDto).toBe('function');
    expect(typeof mappers.dtoToDomainReverseGeocode).toBe('function');
    expect(typeof mappers.errorToRepositoryFailureSearch).toBe('function');
    expect(typeof mappers.dtoToDomainRouteEstimate).toBe('function');
    expect(typeof mappers.dtoToDomainRoutePreview).toBe('function');
    expect(typeof mappers.domainToRouteEstimateDto).toBe('function');
    expect(typeof mappers.dtoToDomainFareEstimatePreview).toBe('function');
    expect(typeof mappers.errorToRepositoryFailureMap).toBe('function');
