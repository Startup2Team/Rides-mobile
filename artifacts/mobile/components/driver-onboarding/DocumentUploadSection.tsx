...
export function DocumentUploadSection({ colors, docs, errors, form, pickDocument, takeDocumentPhoto, update }: {
  ...
  return <View style={styles.section}>
    ...
    <Text style={[styles.sectionDesc, { color: colors.mutedForeground }]}>Upload clear photos of each document. Driver's licence and National ID require front and back images.</Text>
