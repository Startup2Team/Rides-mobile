...
const styles = StyleSheet.create({
  ...
  title: { ...typography.h2, fontFamily: typography.badge.fontFamily, textAlign: 'center' },
  message: { ...typography.bodySmall, fontFamily: typography.body.fontFamily, lineHeight: 20, textAlign: 'center', marginTop: 8 },
