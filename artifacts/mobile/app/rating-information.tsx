...
import {
  RATING_INFORMATION_IMAGES,
  prefetchRatingInformationImages,
} from '@/constants/ratingInformationImages';
...
const RATING_COPY: Record<RatingEducationMode, RatingEducationCopy> = {
  customer: {
    ...
    sections: [
      {
        image: RATING_INFORMATION_IMAGES.rating,
      ...
      {
        image: RATING_INFORMATION_IMAGES.readyToMove,
      ...
      {
        image: RATING_INFORMATION_IMAGES.onTheRoute,
        heading: 'Courtesy.',
      ...
      {
        image: RATING_INFORMATION_IMAGES.traffic,
        heading: 'Safety.',
