...
export const DOMAIN_OWNERSHIP: Record<DomainName, DomainOwnershipEntry> = {
  ...
  vehicle: {
    ...
    currentFiles: ['domains/vehicle/types.ts', 'domains/vehicle/repository.ts', 'domains/vehicle/hooks.ts', 'domains/vehicle/index.ts', 'query/hooks/useDriverVehiclesQuery.ts', 'app/driver-vehicles.tsx', 'app/driver-add-vehicle.tsx', 'app/driver-vehicle-details.tsx', 'app/(driver)/index.tsx', 'app/(driver)/profile.tsx'],
  ...
  'saved-locations': {
    ...
    currentFiles: ['domains/saved-locations/types.ts', 'domains/saved-locations/repository.ts', 'domains/saved-locations/hooks.ts', 'domains/saved-locations/index.ts', 'hooks/useSavedLocations.ts', 'context/SavedLocationsContext.tsx', 'persistence/savedLocationsPersistence.ts', 'app/saved-place-selector.tsx'],
    futureFiles: ['domains/saved-locations/query.ts', 'data/repositories/interfaces.ts'],
